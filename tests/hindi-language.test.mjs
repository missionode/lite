...
assert.match(html, /app\.js\?v=3\.78/, 'The application query version must match the modularized delivery.');
assert.match(serviceWorker, /chakra-v5\.273/, 'The shell cache must be rotated for the locale UI renderer delivery.');
