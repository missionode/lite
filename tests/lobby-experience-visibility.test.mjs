...
assert.match(html, /modules\/lobby-experience-visibility\.js\?v=1\.0[\s\S]*?app\.js\?v=4\.08/);
assert.match(serviceWorker, /chakra-v5\.304[\s\S]*?modules\/lobby-experience-visibility\.js\?v=1\.0/);
