...
assert.match(html, /modules\/mixer-preference-hydration\.js\?v=1\.0[\s\S]*?app\.js\?v=4\.11/);
assert.match(serviceWorker, /chakra-v5\.308[\s\S]*?modules\/mixer-preference-hydration\.js\?v=1\.0/);
