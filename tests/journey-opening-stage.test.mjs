...
assert.ok(html.indexOf('modules/journey-opening-stage.js?v=1.0') < html.indexOf('app.js?v=4.11'));
assert.match(sw, /chakra-v5\.308[\s\S]*?\.\/modules\/journey-opening-stage\.js\?v=1\.0/);
