...
assert.match(html, /modules\/journey-selection-hydration\.js\?v=1\.0[\s\S]*?app\.js\?v=4\.07/);
assert.match(serviceWorker, /chakra-v5\.303[\s\S]*?modules\/journey-selection-hydration\.js\?v=1\.0/);
