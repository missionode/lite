...
const methods=vm.runInNewContext('(class {'+app.slice(app.indexOf('    startDrone(baseFreq'),app.indexOf('    stopGuidedTransitionTone('))+'}).prototype',{state,audioTonePlayback});
