...
assert.match(html, /modules\/guided-noting-practice\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.72/, 'the module should load before app.js with a refreshed app version');
assert.match(serviceWorker, /chakra-v5\.267[\s\S]*?modules\/guided-noting-practice\.js\?v=1\.0/, 'the offline shell should precache the same module version');
