...
assert.match(html, /app\.js\?v=3\.63/, 'The application query version must match the modularized delivery.');
assert.match(serviceWorker, /chakra-v5\.258/, 'The shell cache must be rotated for the Body Scan module delivery.');
