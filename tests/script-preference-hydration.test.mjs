...
assert.match(html, /modules\/script-preference-hydration\.js\?v=1\.0[\s\S]*?app\.js\?v=4\.09/);
assert.match(sw, /chakra-v5\.305[\s\S]*?modules\/script-preference-hydration\.js\?v=1\.0/);
