...
assert.match(html, /modules\/care-preference-hydration\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.91/);
assert.match(sw, /chakra-v5\.287[\s\S]*?modules\/care-preference-hydration\.js\?v=1\.0/);
