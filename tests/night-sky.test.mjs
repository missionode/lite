...
assert.ok(html.indexOf('modules/ambient-particle-field.js?v=1.0') < html.indexOf('app.js?v=4.10'));
assert.match(serviceWorker,/chakra-v5\.306[\s\S]*?modules\/ambient-particle-field\.js\?v=1\.0/,
