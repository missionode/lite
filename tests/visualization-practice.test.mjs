...
assert.match(html, /modules\/visualization-practice\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.67/);
assert.match(serviceWorker, /chakra-v5\.262[\s\S]*?modules\/visualization-practice\.js\?v=1\.0/);
