...
assert.match(html, /modules\/practice-module-loader\.js\?v=1\.0[\s\S]*?app\.js\?v=4\.05/);
assert.doesNotMatch(html, /modules\/undo-unlearn-practice\.js/);
assert.match(serviceWorker, /chakra-v5\.301[\s\S]*?modules\/undo-unlearn-practice\.js\?v=1\.0/);
