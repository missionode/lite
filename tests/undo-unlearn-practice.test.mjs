...
assert.match(html, /modules\/undo-unlearn-practice\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.69/);
assert.match(serviceWorker, /chakra-v5\.264[\s\S]*?modules\/undo-unlearn-practice\.js\?v=1\.0/);
