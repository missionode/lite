...
assert.match(html, /modules\/mood-ambience-settings-view\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.88/);
assert.match(serviceWorker, /chakra-v5\.284[\s\S]*?modules\/mood-ambience-settings-view\.js\?v=1\.0/);
