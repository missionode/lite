...
assert.ok(html.indexOf('modules/ambient-particle-field.js?v=1.0') < html.indexOf('app.js?v=4.04'));
assert.match(serviceWorker,/chakra-v5\.300[\s\S]*?modules\/ambient-particle-field\.js\?v=1\.0/,
