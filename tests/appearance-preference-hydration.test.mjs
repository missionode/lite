...
assert.match(html, /modules\/appearance-preference-hydration\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.94/);
assert.match(sw, /chakra-v5\.290[\s\S]*?modules\/appearance-preference-hydration\.js\?v=1\.0/);
