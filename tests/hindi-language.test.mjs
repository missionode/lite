...
assert.match(html, /app\.js\?v=3\.99/, 'The application query version must match the modularized delivery.');
assert.match(serviceWorker, /chakra-v5\.295/, 'The shell cache must be rotated for the locale UI renderer delivery.');
