...
assert.match(html, /modules\/practice-module-loader\.js\?v=1\.0[\s\S]*?app\.js\?v=4\.07/);
assert.doesNotMatch(html, /modules\/undo-unlearn-practice\.js/);
assert.match(serviceWorker, /chakra-v5\.303[\s\S]*?modules\/undo-unlearn-practice\.js\?v=1\.0/);
