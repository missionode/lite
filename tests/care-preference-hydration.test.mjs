...
assert.match(html, /modules\/care-preference-hydration\.js\?v=1\.0[\s\S]*?app\.js\?v=4\.01/);
assert.match(sw, /chakra-v5\.297[\s\S]*?modules\/care-preference-hydration\.js\?v=1\.0/);
