...
assert.match(html, /modules\/journey-selection-hydration\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.97/);
assert.match(serviceWorker, /chakra-v5\.293[\s\S]*?modules\/journey-selection-hydration\.js\?v=1\.0/);
