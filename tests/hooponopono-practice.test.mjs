...
assert.match(html, /modules\/hooponopono-practice\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.78/);
assert.match(serviceWorker, /chakra-v5\.273[\s\S]*?modules\/hooponopono-practice\.js\?v=1\.0/);
