...
### Client verification and professional verbal consent — 2026-08-11

- Recorded plan pre-roll now begins with explicit client-verification pages containing name, contact number, email, citizenship, emergency-contact name/phone, and the full meditation-language name. This intentionally supersedes the earlier recording allowlist that excluded contact and emergency details; medication details, private reflections, and guide notes remain excluded.
- The meditation language is rendered as `English` or `Malayalam`, never the storage codes `en` or `ml`, and appears in the formal document header as well as its verification field. The spoken evidence header repeats the full language name.
- Split detailed plan presentation from verbal-consent narration. Plan pages may retain approved poses and timing, but the client reads only professional categories: guided meditation and relaxation, guided yoga, and personal wellness/assisted-care services. Pose names, individual care-stage names, and durations are not repeated in the spoken declaration.
- Rewrote English and Malayalam consent as a more formal declaration covering reviewed approval, non-medical scope, opportunity for questions, optional-service refusal, modification, pause, withdrawal, stopping, voluntary participation, and audio-video recording.
