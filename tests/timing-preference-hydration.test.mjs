...
assert.ok(loadPreferences.indexOf('timingPreferenceHydration.hydrateJourney(') < loadPreferences.indexOf("syncValue('brightness-slider'"));
assert.match(html, /modules\/timing-preference-hydration\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.84/);
assert.match(serviceWorker, /chakra-v5\.279[\s\S]*?modules\/timing-preference-hydration\.js\?v=1\.0/);
