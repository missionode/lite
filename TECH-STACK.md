...
HRIM has a local-time safety gate: it is startable from 03:30 through 17:59 and is blocked from 18:00 through 03:29. The gate runs before Sleep Mode selection, audio initialization, and narration. At and after 18:00, the evening Sleep Mode decision takes priority; users blocked from HRIM can return to the Lobby or continue with regular meditation, which remains available at all times.
