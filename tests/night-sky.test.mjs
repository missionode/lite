...
assert.ok(html.indexOf('modules/ambient-particle-field.js?v=1.0') < html.indexOf('app.js?v=3.97'));
assert.match(serviceWorker,/chakra-v5\.293[\s\S]*?modules\/ambient-particle-field\.js\?v=1\.0/,
