...
assert.match(html, /modules\/hooponopono-practice\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.68/);
assert.match(serviceWorker, /chakra-v5\.263[\s\S]*?modules\/hooponopono-practice\.js\?v=1\.0/);
