...
assert.match(html, /modules\/lobby-experience-visibility\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.84/);
assert.match(serviceWorker, /chakra-v5\.279[\s\S]*?modules\/lobby-experience-visibility\.js\?v=1\.0/);
