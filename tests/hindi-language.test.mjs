...
assert.match(html, /app\.js\?v=3\.64/, 'The application query version must match the modularized delivery.');
assert.match(serviceWorker, /chakra-v5\.259/, 'The shell cache must be rotated for the practice module delivery.');
