...
assert.match(html, /modules\/script-preference-hydration\.js\?v=1\.0[\s\S]*?app\.js\?v=4.12/);
assert.match(sw, /chakra-v5.309[\s\S]*?modules\/script-preference-hydration\.js\?v=1\.0/);
