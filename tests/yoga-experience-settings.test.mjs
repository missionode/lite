...
assert.match(html, /modules\/yoga-experience-settings\.js\?v=1\.0[\s\S]*?app\.js\?v=4\.06/);
assert.match(serviceWorker, /chakra-v5\.302[\s\S]*?modules\/yoga-experience-settings\.js\?v=1\.0/);
