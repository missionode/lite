...
assert.match(html, /modules\/ambient-particle-field\.js\?v=1\.0[\s\S]*?modules\/visual-engine\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.99/,
    'The shared visual-effect owner must load after sky dependencies and before the app.');
assert.match(readFileSync('sw.js', 'utf8'), /chakra-v5\.295[\s\S]*?modules\/visual-engine\.js\?v=1\.0/,
