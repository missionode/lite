...
assert.match(html, /modules\/lobby-experience-visibility\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.93/);
assert.match(serviceWorker, /chakra-v5\.289[\s\S]*?modules\/lobby-experience-visibility\.js\?v=1\.0/);
