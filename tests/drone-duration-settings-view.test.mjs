...
assert.match(html, /modules\/drone-duration-settings-view\.js\?v=1\.0[\s\S]*?app\.js\?v=4\.01/);
assert.match(serviceWorker, /chakra-v5\.297[\s\S]*?modules\/drone-duration-settings-view\.js\?v=1\.0/);
