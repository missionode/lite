...
assert.match(html, /modules\/yoga-experience-settings\.js\?v=1\.0[\s\S]*?app\.js\?v=4\.05/);
assert.match(serviceWorker, /chakra-v5\.301[\s\S]*?modules\/yoga-experience-settings\.js\?v=1\.0/);
