...
assert.match(html, /modules\/session-mode-hydration\.js\?v=1\.0[\s\S]*?app\.js\?v=4\.08/);
assert.match(serviceWorker, /chakra-v5\.304[\s\S]*?modules\/session-mode-hydration\.js\?v=1\.0/);
