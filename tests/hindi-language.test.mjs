...
assert.match(html, /app\.js\?v=2\.35/, 'The application query version must be rotated for the current language delivery.');
assert.match(serviceWorker, /chakra-v5\.109/, 'The shell cache must be rotated for the current language delivery.');
assert.match(serviceWorker, /chakra-language-v22/, 'The language cache must be rotated for the current language delivery.');
