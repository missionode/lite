...
assert.match(html, /modules\/timing-preference-hydration\.js\?v=1\.0[\s\S]*?app\.js\?v=4\.10/);
assert.match(serviceWorker, /chakra-v5\.306[\s\S]*?modules\/timing-preference-hydration\.js\?v=1\.0/);
