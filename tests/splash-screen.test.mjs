...
assert.match(html, /id="splash-screen"[\s\S]*?src="Splash-v2\.png"/, 'The redesigned splash image should load at launch');
...
assert.match(styles, /#splash-screen::before[\s\S]*?url\('Splash-v2\.png'\)/, 'Splash should fill wide screens with a softened image backdrop');
