...
assert.match(html, /modules\/audio-engine-initialization\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.98/);
assert.match(serviceWorker, /chakra-v5\.294[\s\S]*?modules\/audio-engine-initialization\.js\?v=1\.0/);
