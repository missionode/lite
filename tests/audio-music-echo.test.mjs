...
assert.ok(html.indexOf('modules/audio-music-echo.js?v=1.0') < html.indexOf('app.js?v=4.12'));
assert.match(sw, /chakra-v5.310[\s\S]*?\.\/modules\/audio-music-echo\.js\?v=1\.0/);
