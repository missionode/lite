...
assert.match(html, /modules\/care-preference-hydration\.js\?v=1\.0[\s\S]*?app\.js\?v=4.12/);
assert.match(sw, /chakra-v5.310[\s\S]*?modules\/care-preference-hydration\.js\?v=1\.0/);
