...
assert.match(html, /modules\/locale-ui-renderer\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.85/);
assert.match(serviceWorker, /chakra-v5\.280[\s\S]*?modules\/locale-ui-renderer\.js\?v=1\.0/);
