...
assert.match(html, /modules\/script-preference-hydration\.js\?v=1\.0[\s\S]*?app\.js\?v=4\.00/);
assert.match(sw, /chakra-v5\.296[\s\S]*?modules\/script-preference-hydration\.js\?v=1\.0/);
