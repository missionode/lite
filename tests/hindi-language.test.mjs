...
assert.match(html, /app\.js\?v=2\.15/, 'The application query version must be rotated for the current language delivery.');
assert.match(serviceWorker, /chakra-v5\.86/, 'The shell cache must be rotated for the current language delivery.');
assert.match(serviceWorker, /chakra-language-v20/, 'The language cache must be rotated for the current language delivery.');
