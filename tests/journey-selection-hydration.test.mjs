...
assert.match(html, /modules\/journey-selection-hydration\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.99/);
assert.match(serviceWorker, /chakra-v5\.295[\s\S]*?modules\/journey-selection-hydration\.js\?v=1\.0/);
