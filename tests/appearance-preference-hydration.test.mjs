...
assert.match(html, /modules\/appearance-preference-hydration\.js\?v=1\.0[\s\S]*?app\.js\?v=4\.04/);
assert.match(sw, /chakra-v5\.300[\s\S]*?modules\/appearance-preference-hydration\.js\?v=1\.0/);
