...
assert.match(html, /modules\/box-breathing-practice\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.73/, 'the module should load before app.js with a refreshed app version');
assert.match(serviceWorker, /chakra-v5\.268[\s\S]*?modules\/box-breathing-practice\.js\?v=1\.0/, 'the offline shell should precache the module');
