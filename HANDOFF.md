...
- Follow-up audio fix: the background music loop now uses the full 10-second entry envelope internally as well as on the outer music gain. This prevents a restarted loop from becoming audible through the previous 3-second inner fade before the intended entry fade completes.
