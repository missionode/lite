...
assert.match(html, /modules\/script-preference-hydration\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.99/);
assert.match(sw, /chakra-v5\.295[\s\S]*?modules\/script-preference-hydration\.js\?v=1\.0/);
