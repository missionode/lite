...
const enginePosition = html.indexOf('../modules/assessment-tournament.js?v=1.1');
...
assert.match(inlineScripts[0], /fetch\('\.\.\/data\/assessment-questions\.json\?v=1\.0'\)/,
...
for (const id of [
    ...
    'chakraResults', 'archetypeResults', 'operatorDot', 'newAssessment'
]) {
...
assert.doesNotMatch(inlineScripts[0], /startJourney|selectedChakras|journeyConfig|advancedFeatures/,
