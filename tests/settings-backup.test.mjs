...
assert.ok(
    html.indexOf('modules/settings-backup.js?v=1.0') < html.indexOf('app.js?v=3.89'),
    'The settings backup module must load before the application consumes its API.'
);
assert.ok(
    html.indexOf('modules/app-state.js?v=1.1') < html.indexOf('app.js?v=3.89'),
...
assert.ok(
    html.indexOf('modules/content-localization.js?v=1.0') < html.indexOf('app.js?v=3.89'),
...
assert.ok(
    html.indexOf('modules/media-lifecycle.js?v=1.0') < html.indexOf('app.js?v=3.89'),
...
assert.ok(
    html.indexOf('modules/piper-lifecycle.js?v=1.0') < html.indexOf('app.js?v=3.89'),
...
assert.ok(
    html.indexOf('modules/audio-route-lifecycle.js?v=1.0') < html.indexOf('app.js?v=3.89'),
...
assert.ok(
    html.indexOf('modules/journey-routing.js?v=1.2') < html.indexOf('app.js?v=3.89'),
...
assert.ok(
    html.indexOf('modules/practice-module-loader.js?v=1.0') < html.indexOf('app.js?v=3.89'),
...
assert.ok(
    html.indexOf('modules/yoga-experience-settings.js?v=1.0') < html.indexOf('app.js?v=3.89'),
...
assert.ok(html.indexOf('modules/locale-ui-renderer.js?v=1.0') < html.indexOf('app.js?v=3.89'), 'Locale UI rendering must load before the app uses it.');
assert.match(serviceWorker, /chakra-v5\.285[\s\S]*?\.\/modules\/locale-ui-renderer\.js\?v=1\.0/, 'Locale UI rendering must remain available offline.');
