...
assert.ok(html.indexOf('modules/journey-hypnosis-wrapper.js?v=1.0') < html.indexOf('app.js?v=4.10'));
assert.match(sw, /chakra-v5\.306[\s\S]*?\.\/modules\/journey-hypnosis-wrapper\.js\?v=1\.0/);
