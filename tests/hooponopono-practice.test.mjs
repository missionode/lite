...
assert.match(html, /modules\/hooponopono-practice\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.74/);
assert.match(serviceWorker, /chakra-v5\.269[\s\S]*?modules\/hooponopono-practice\.js\?v=1\.0/);
