...
assert.match(html, /modules\/script-preference-hydration\.js\?v=1\.0[\s\S]*?app\.js\?v=4\.06/);
assert.match(sw, /chakra-v5\.302[\s\S]*?modules\/script-preference-hydration\.js\?v=1\.0/);
