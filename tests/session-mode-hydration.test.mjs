...
assert.match(html, /modules\/session-mode-hydration\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.81/);
assert.match(serviceWorker, /chakra-v5\.276[\s\S]*?modules\/session-mode-hydration\.js\?v=1\.0/);
