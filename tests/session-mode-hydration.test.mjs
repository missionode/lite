...
assert.match(html, /modules\/session-mode-hydration\.js\?v=1\.0[\s\S]*?app\.js\?v=4\.09/);
assert.match(serviceWorker, /chakra-v5\.305[\s\S]*?modules\/session-mode-hydration\.js\?v=1\.0/);
