...
assert.match(html, /modules\/drone-duration-settings-view\.js\?v=1\.0[\s\S]*?app\.js\?v=4\.11/);
assert.match(serviceWorker, /chakra-v5\.308[\s\S]*?modules\/drone-duration-settings-view\.js\?v=1\.0/);
