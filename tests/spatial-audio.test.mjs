...
assert.match(audioEffectsSettingsView, /storage\.setItem\('chakra_spatial_mode', state\.spatialMode\)/, 'Spatial mode changes should persist');
assert.match(audioEffectsSettingsView, /getElementById\('spatial-mode'\)\?\.addEventListener\('change'/);
