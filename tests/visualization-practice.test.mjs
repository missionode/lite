...
assert.match(html, /modules\/visualization-practice\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.85/);
assert.match(serviceWorker, /chakra-v5\.280[\s\S]*?modules\/visualization-practice\.js\?v=1\.0/);
