...
assert.ok(html.indexOf('modules/ambient-particle-field.js?v=1.0') < html.indexOf('app.js?v=3.96'));
assert.match(serviceWorker,/chakra-v5\.292[\s\S]*?modules\/ambient-particle-field\.js\?v=1\.0/,
