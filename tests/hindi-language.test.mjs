...
assert.match(html, /app\.js\?v=3\.50/, 'The application query version must be rotated for the current language delivery.');
assert.match(serviceWorker, /chakra-v5\.243/, 'The shell cache must be rotated for the current language delivery.');
assert.match(serviceWorker, /chakra-language-v52/, 'The current locale cache generation must remain declared for language delivery.');
