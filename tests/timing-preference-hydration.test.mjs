...
assert.match(html, /modules\/timing-preference-hydration\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.91/);
assert.match(serviceWorker, /chakra-v5\.287[\s\S]*?modules\/timing-preference-hydration\.js\?v=1\.0/);
