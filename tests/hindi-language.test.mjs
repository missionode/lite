...
assert.match(html, /app\.js\?v=2\.34/, 'The application query version must be rotated for the current language delivery.');
assert.match(serviceWorker, /chakra-v5\.108/, 'The shell cache must be rotated for the current language delivery.');
