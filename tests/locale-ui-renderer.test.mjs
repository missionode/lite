...
assert.match(html, /modules\/locale-ui-renderer\.js\?v=1\.0[\s\S]*?app\.js\?v=4\.04/);
assert.match(serviceWorker, /chakra-v5\.300[\s\S]*?modules\/locale-ui-renderer\.js\?v=1\.0/);
