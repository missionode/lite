...
assert.match(html, /modules\/appearance-preference-hydration\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.98/);
assert.match(sw, /chakra-v5\.294[\s\S]*?modules\/appearance-preference-hydration\.js\?v=1\.0/);
