...
assert.match(html, /modules\/hooponopono-practice\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.72/);
assert.match(serviceWorker, /chakra-v5\.267[\s\S]*?modules\/hooponopono-practice\.js\?v=1\.0/);
