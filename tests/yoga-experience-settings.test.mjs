...
assert.match(html, /modules\/yoga-experience-settings\.js\?v=1\.0[\s\S]*?app\.js\?v=4\.01/);
assert.match(serviceWorker, /chakra-v5\.297[\s\S]*?modules\/yoga-experience-settings\.js\?v=1\.0/);
