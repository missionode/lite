...
assert.match(html, /modules\/drone-duration-settings-view\.js\?v=1\.0[\s\S]*?app\.js\?v=3\.89/);
assert.match(serviceWorker, /chakra-v5\.285[\s\S]*?modules\/drone-duration-settings-view\.js\?v=1\.0/);
