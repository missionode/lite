...
assert.ok(html.indexOf('modules/ambient-particle-field.js?v=1.0') < html.indexOf('app.js?v=4.11'));
assert.match(serviceWorker,/chakra-v5\.308[\s\S]*?modules\/ambient-particle-field\.js\?v=1\.0/,
