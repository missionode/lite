...
assert.match(html, /app\.js\?v=3\.59/, 'The application query version must be rotated for the current delivery.');
assert.match(serviceWorker, /chakra-v5\.252/, 'The shell cache must be rotated for the current delivery.');
