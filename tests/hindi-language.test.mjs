...
assert.match(html, /app\.js\?v=3\.09/, 'The application query version must be rotated for the current language delivery.');
assert.match(serviceWorker, /chakra-v5\.196/, 'The shell cache must be rotated for the current language delivery.');
assert.match(serviceWorker, /chakra-language-v29/, 'The current locale cache generation must remain declared for language delivery.');
